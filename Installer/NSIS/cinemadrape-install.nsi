...
;Version Information
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "2.2.0.330"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductVersion" "2.2.0.330"
...
Section
  ...
  WriteRegStr   HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\CinemaDrape" "DisplayVersion" "2.2.0.330"
